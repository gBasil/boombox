...
To quote myself, asp er the text on the homepage of the website:
...
- When adding the authors of a song, they will be split by "`, `", for example when dealing with remixes to credit the original author and the remixer.
